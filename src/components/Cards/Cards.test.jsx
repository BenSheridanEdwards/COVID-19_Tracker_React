...
it('renders cards component without error', () =>{
  const wrapper = setup({ data: { confirmed: { value: 1000000 }, recovered: { value: 900000 }, deaths: { value: 100000 }, lastUpdate: "2020-05-02T19:32:29.000Z" }});
...
describe('it renders the infected card item with the expected content', () => {
  ...
  let infectedCard
  beforeEach(() => {
    wrapper = setup({ data: { confirmed: { value: 1000000 }, recovered: { value: 900000 }, deaths: { value: 100000 }, lastUpdate: "2020-05-02T19:32:29.000Z"}});
...
describe('it renders the recovered card item with the expected content', () => {
  ...
  it('should render the text `Number of recoveries from COVID-19`', () => {
    expect(recoveredCard.text()).toContain('Number of recoveries from COVID-19')
  })
})
